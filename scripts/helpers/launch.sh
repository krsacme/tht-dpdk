...
openstack subnet create public --subnet-range 172.150.0.0/24 --network public --allocation-pool start=172.150.0.210,end=172.150.0.230 --dns-nameserver 8.8.8.8 --no-dhcp
